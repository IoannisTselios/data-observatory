...
DATASET_URL = (
    ...
    "&request=GetFeature&typeName=k101:trae_basis&outputFormat=csv&SRSNAME=EPSG:4326"
)
RAW_TABLE_NAME = "cph_tree_base_raw"


def main():
    logger.info("Ingesting Copenhagen tree base")
